...
import { accessibilityContent } from "@/lib/content/legal/accessibility-content";
...
const PAGE_NAMESPACE = "pages.legal.accessibility";
...
/**
 * Accessibility declaration of the Banque centrale d'Astoria portal.
 *
 * Content is fully driven by the message catalogs
 * (`pages.legal.accessibility.*` and `pages.legal.related.*`) through
...
export default async function AccessibilityPage({ params }: PageProps) {
  ...
  return <ThemeArticle content={localizeArticle(accessibilityContent, t, tRelated)} currentHref={PAGE_PATH} />;
}