...
import { termsContent } from "@/lib/content/legal/terms-content";
...
const PAGE_NAMESPACE = "pages.legal.terms";
...
/**
 * Terms of use of the Banque centrale d'Astoria portal.
 *
 * Content is fully driven by the message catalogs
 * (`pages.legal.terms.*` and `pages.legal.related.*`) through
...
export default async function TermsPage({ params }: PageProps) {
  ...
  return <ThemeArticle content={localizeArticle(termsContent, t, tRelated)} currentHref={PAGE_PATH} />;
}